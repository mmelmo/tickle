# CREATE CGLIST AD WITH LATEST TICKETMASTER EVENT
...
# - cron job to post cglist ad as soon as old one expires
...
print "zip code: "
zip_code = gets.gsub("\n", "")
print "ticketmaster email: "
ticketmaster_email = gets.gsub("\n", "")
print "ticketmaster password: "
ticketmaster_password = gets.gsub("\n", "")
print "price per ticket: "
price_per_ticket = gets.gsub("\n","")
print "additional ticket info: "
...
print "signing into ticketmaster... "
...
print "activating craigslist ad... "
b.goto("gmail.com")
